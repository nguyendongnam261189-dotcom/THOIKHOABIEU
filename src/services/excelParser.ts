  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        // 🔥 5. KẾT XUẤT DỮ LIỆU: CỨU VÃN TỔ CHUYÊN MÔN
        ...
        Array.from(allTeachersMap.values()).forEach(t => {
            ...
            // Logic cứu vãn tổ chuyên môn: Nếu đang là Chung, thử đoán từ môn dạy
            ...
            if (mergedTeachersMap.has(mappedName)) {
                ...
                // Cập nhật tổ nếu tổ cũ là Chung mà tổ mới tìm được giá trị tốt hơn
                if (existing.group === 'Chung' && finalGroup !== 'Chung') {
                    existing.group = finalGroup;
                }
            } else {
